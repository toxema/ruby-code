...
/**
 * A UI delegate for JLabel that rotates the label 90º <P> Extends
 * {@link BasicLabelUI}. <P> The only difference between the appearance of
 * labels in the Basic and Metal L&Fs is the manner in which diabled text is
 * painted. As VerticalLabelUI does not override the method paintDisabledText,
 * this class can be adapted for Metal L&F by extending MetalLabelUI instead of
 * BasicLabelUI. <P> No other changes are required.
 *
 * @author Darryl
 */
public class VerticalLabelUI extends BasicLabelUI {
          ...
          /**
           * Constructs a
           * <code>VerticalLabelUI</code> with the default anticlockwise
           * rotation
           */
          ...
          /**
           * Overridden to always return -1, since a vertical label does not
           ...
           * before invoking the super method and copies them after they have
           * been altered by {@link SwingUtilities#layoutCompoundLabel(FontMetrics, String,
